...
namespace CinemaApp.datos
{
    class HelperDB
    {
        ...
        private HelperDB()
        {
            cnn = new SqlConnection(@"Data Source=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=DB_CINEMA;Data Source=LAPTOP-HM31I94B\SQLEXPRESS");
        }
